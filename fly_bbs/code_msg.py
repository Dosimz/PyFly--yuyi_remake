...
RE_ACTIVATE_MAIL_SEND = R(status=0, msg='重新发送邮件成功, 请前往您的邮箱查看激活你的账号')
REGISTER_SUCCESS = R(status=0, msg='用户注册成功，请前往您的邮箱查看激活您的账号后登录')
...
# 参数效验相关 50001
# 用户
PASSWORD_LENGTH_ERROR = R(status=50001, msg='密码长度在6-16之间')
...
NOW_PASSWORD_EMPTY = R(status=50001, msg='两次输入密码不一致')
# ??
